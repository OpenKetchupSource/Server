...
🔗 Soulmate 관련 링크
🔗 프론트엔드 배포 URL: SoulMate 🧠💗
🛠️ 백엔드 테스트 URL: SoulMate API test 🧪
💻 GitHub:
프론트엔드: FE repo 👀
백엔드: BE repo 👩🏻‍💻
📘 Notion 문서: 프로젝트 문서 바로가기
🛠️ 기술 스택 요약
분류	기술
...
📦 설치 및 실행
0. Github clone
git clone https://github.com/OpenKetchupSource/Server.git
cd Server

1. 빌드 및 실행 (JDK 21과 MySQL이 설치되어 있어야 합니다.)
   Gradle 빌드: ./gradlew build
   서버 실행: java -jar build/libs/soulmate-0.0.1-SNAPSHOT.jar
